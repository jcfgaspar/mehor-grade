...
export default function LoginForm() {
  ...
  const onSubmit = (data) => {
    ...
    fetch(
      routes.internal.v1.disciplinas.delete +
        `/prerequisito?codigo=${disciplina_b}`,
      {
        method: "PUT",
...
const message200 = {
  info: {
    title: "Sucesso!",
    time: "Agora",
    message: "Pré-requisito desvinculados",
  },
};
...
const messageError = {
  info: {
    ...
    time: "Agora",
    message: "Não foi possível desvincular o pré-requisito ",
  },
};
