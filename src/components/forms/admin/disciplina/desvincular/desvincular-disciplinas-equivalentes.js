...
export default function LoginForm() {
  ...
  const onSubmit = data => {
    ...
    fetch(routes.internal.v1.disciplinas.delete + `/equivalencia?codigo=${disciplina_b}`, {
      method: "PUT",
  ...
  return (
    <>
      <h2>Desvincular Equivalentes</h2>
      <hr></hr>
...
const message200 = {
  info: {
    title: "Sucesso",
    time: "Agora",
    message: "disciplinas desvinculadas",
  }
}
...
const messageError = {
  info: {
    ...
    time: "Agora",
    message: "Não foi possível desvincular disciplinas",
  }
}